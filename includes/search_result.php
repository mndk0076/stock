...
<body>
    <div class="container">
        <h2 class="sr-title">Apple Inc (AAPL)</h2>
        <hr class="hr"/>
        <div>
            <ul>
        ...
        <img src="../images/search_result_info.PNG" alt="Smiley face" class="img">
        <br/><br/><h1 class="news">Related News</h1>
        <img src="../images/news.PNG" alt="Smiley face" class="img">
    </div>
