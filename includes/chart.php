...
<body>
    <div class="container">
        <h2 class="chart-title">Apple Inc (AAPL)</h2>
        <i class="fas fa-long-arrow-alt-up"></i>
        <span class="chart-data">+1.54 (2.3%)</span>
        <div class="container">
            <div class="chart-wrapper">
            <input class="form-control chart-search" type="text" placeholder="Search ticker" aria-label="Search">
            <div class="row-chart">
